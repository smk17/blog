...
import CodeMirror from "components/react-codemirror";
...
class Editor extends Component {
  ...
  setCustomImageHosting = () => {
    ...
    const { url, name, isSmmsOpen, isQiniuyunOpen, isAliyunOpen, isGiteeOpen, isGitHubOpen } =
  ...
  render() {
    ...
    const { isEditAreaOpen, isPreviewAreaOpen, isStyleEditorOpen, isImmersiveEditing } =
      this.props.view;
